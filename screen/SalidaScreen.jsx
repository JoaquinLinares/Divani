        ...
        if (!isScanning) {
            ...
            if (existingProductIndexx !== -1) {
                ...
                if (updatedItem.stock >= 0) {
                    ...
                    setScanMessage(`Se escaneo correctamente: ${data}`);
                } else {
                    // Si el stock es menor que cero, no actualiza el item y muestra un mensaje de error
                    setScanMessage(`No se puede actualizar el stock para ${data}, stock insuficiente`);
                }
            } else {
                setScanMessage(`Producto no encontrado: ${data}`);
            }
        ...
        <View style={styles.mainContainer}>
            ...
            {!openCamera && (
                <View style={styles.navbar}>
                    ...
                    <Text style={styles.centerText}>Salida</Text>
            ...
            {!openCamera && (
                <View style={styles.sectionContainer}>
                    ...
                    {scannedData.length > 0 ? ( // Renderiza los datos escaneados si hay algún elemento
                        ...
                        // Esto se muestra cuando no hay productos escaneados
                        <View style={stylesIMG.imageContainer}>
                            <Image source={imageSource} style={stylesIMG.image} />
                            <Text style={stylesIMG.largeText}>Quitar sus articulos</Text>
                        </View>
                    )}
                </View>
            )}
